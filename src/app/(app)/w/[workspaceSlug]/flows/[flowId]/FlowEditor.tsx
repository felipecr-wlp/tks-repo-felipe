  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 relative">
        ...
        <ReactFlow nodes={nodes} edges={edges} onNodesChange={onNodesChange} onEdgesChange={onEdgesChange} onConnect={onConnect} onNodesDelete={onNodesDelete} onNodeDragStop={onNodeDragStop} onNodeDoubleClick={handleNodeDoubleClick} onNodeContextMenu={onNodeContextMenu} onEdgeContextMenu={onEdgeContextMenu} onPaneClick={onPaneClick} nodeTypes={{custom:CustomNode,shape:ShapeNode}} fitView className="bg-background rf-edges-on-top">
        ...
        <div className="absolute bg-card border rounded-lg shadow-lg z-20 transition-all" style={{right:toolPos.x||12,top:toolPos.y||60,width:toolCollapsed?40:180}}>
          ...
          {!toolCollapsed&&<div className="flex flex-col gap-1 p-2">
            ...
            <button className="inline-flex items-center justify-start gap-1.5 rounded px-1.5 py-1 text-xs hover:bg-accent transition-colors" onClick={()=>addShape('text')}><Type className="w-3.5 h-3.5"/>Texto</button>
            <hr className="my-0.5"/>
